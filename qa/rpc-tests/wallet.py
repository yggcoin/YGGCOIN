...
#   c) node1 mines 32 blocks, so now node 0 has 500000YGG, node 1 has 4250YGG, node2 has none.
#   d) node0 sends 601 YGG to node2, in two transactions (301 YGG, then 300 YGG).

...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Ygg features */
        {"ygg", "masternode", &masternode, true, true, false},
        {"ygg", "listmasternodes", &listmasternodes, true, true, false},
        {"ygg", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ygg", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ygg", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ygg", "masternodedebug", &masternodedebug, true, true, false},
        {"ygg", "startmasternode", &startmasternode, true, true, false},
        {"ygg", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ygg", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ygg", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ygg", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ygg", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ygg", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ygg", "mnbudget", &mnbudget, true, true, false},
        {"ygg", "preparebudget", &preparebudget, true, true, false},
        {"ygg", "submitbudget", &submitbudget, true, true, false},
        {"ygg", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ygg", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ygg", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ygg", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ygg", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ygg", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ygg", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ygg", "checkbudgets", &checkbudgets, true, true, false},
        {"ygg", "mnsync", &mnsync, true, true, false},
        {"ygg", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> ygg-cli " + methodname + " " + args + "\n";
}

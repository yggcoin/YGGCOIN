...
/* Ygg GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Ygg"
#define QAPP_ORG_DOMAIN "yggcoin.io"
#define QAPP_APP_NAME_DEFAULT "Ygg-Qt"
#define QAPP_APP_NAME_TESTNET "Ygg-Qt-testnet"

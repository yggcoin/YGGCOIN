...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 10 * 60; // Ygg: 5 blocks
        nTargetSpacing = 2 * 60;  // Ygg: 2 minute
        nMaturity = 10;
        ...
        nLastPOWBlock = 500;
        nModifierUpdateBlock = 1; // we use the version 2 for YGG
        ...
        // DNS Seeding
        vSeeds.push_back(CDNSSeedData("seed1.yggcoin.com", "seed1.yggcoin.com"));
        vSeeds.push_back(CDNSSeedData("seed2.yggcoin.com", "seed2.yggcoin.com"));
        vSeeds.push_back(CDNSSeedData("seed3.yggcoin.com", "seed3.yggcoin.com"));
        vSeeds.push_back(CDNSSeedData("seed4.yggcoin.com", "seed4.yggcoin.com"));

        // Ygg addresses start with 'Y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 78);
        // Ygg script addresses start with '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 20);
        // Ygg private keys start with '9' or 'A'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 22);
        // Ygg BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x88)(0xB2)(0x1E).convert_to_container<std::vector<unsigned char> >();
        // Ygg BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x88)(0xAD)(0xE4).convert_to_container<std::vector<unsigned char> >();
        // Ygg BIP44 coin type is '38201'
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Ygg: 1 day
        nTargetSpacing = 2 * 60;  // Ygg: 1 minute
        nLastPOWBlock = 500;
        nMaturity = 15;
        ...
        // Testnet Ygg addresses start with 'n'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 112);
        // Testnet Ygg script addresses start with '5'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 10);
        // Testnet private keys start with '5' or 'n' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 240);
        // Testnet Ygg BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x04)(0x35)(0x87)(0xCF).convert_to_container<std::vector<unsigned char> >();
        // Testnet Ygg BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x04)(0x35)(0x83)(0x94).convert_to_container<std::vector<unsigned char> >();
        // Testnet Ygg BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Ygg: 1 day
        nTargetSpacing = 2 * 60;        // Ygg: 1 minutes
        bnProofOfWorkLimit = ~uint256(0) >> 1;

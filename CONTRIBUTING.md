Contributing to Ygg Core
==================================

The Ygg Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Ygg Core project, and is not to be
confused with overall Ygg Network Protocol consensus changes.

Whether a pull request is merged into Ygg Core rests with the project merge
...
Patches that change Ygg consensus rules are considerably more involved than
...
Where a patch set proposes to change the Ygg consensus, it must have been
...
The project leader is the release manager for each Ygg Core release.

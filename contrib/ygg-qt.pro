...
RESOURCES += src/qt/ygg.qrc src/qt/ygg_locale.qrc

TRANSLATIONS += src/qt/locale/ygg_bg.ts \
                src/qt/locale/ygg_de.ts \
                src/qt/locale/ygg_en.ts \
                src/qt/locale/ygg_es.ts \
                src/qt/locale/ygg_fi.ts \
                src/qt/locale/ygg_fr.ts \
                src/qt/locale/ygg_it.ts \
                src/qt/locale/ygg_ja.ts \
                src/qt/locale/ygg_pl.ts \
                src/qt/locale/ygg_pt.ts \
                src/qt/locale/ygg_ru.ts \
                src/qt/locale/ygg_sk.ts \
                src/qt/locale/ygg_sv.ts \
                src/qt/locale/ygg_vi.ts \
                src/qt/locale/ygg_zh_CN.ts \
                src/qt/locale/ygg_zh_TW.ts

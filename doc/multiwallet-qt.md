...
In order to support loading of multiple wallets in ygg-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is ygg.cpp.
...
Changes to ygg.cpp
----------------------
ygg.cpp is the entry point into ygg-qt, and as such, will require some minor modifications to provide hooks for

...
This mechanism has been integrated into Bitcore-Node-Ygg which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/yggcoin/insight-api-ygg#web-socket-api](https://github.com/yggcoin/insight-api-ygg#web-socket-api)
* API: [https://github.com/yggcoin/insight-api-ygg#swifttx-transactions](https://github.com/yggcoin/insight-api-ygg#swifttx-transactions)
...
By default, the Ygg Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Ygg Core daemon:

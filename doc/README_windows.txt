...
Intro
-----
Ygg (YGG) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. Ygg utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run ygg-qt.exe.

Ygg Core is the original Ygg client and it builds the backbone of the network.
However, it downloads and stores the entire history of Ygg transactions;
